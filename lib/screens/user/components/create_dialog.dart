...
Future<dynamic> createDialog({
  ...
  var dialog = showDialog(
    ...
    builder: (_) {
      return AlertDialog(
        title: Text(type == Type.create ? "Create new user" : "Update user", textAlign: TextAlign.center),
        content: Form(
          key: formKey,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      if (isValid) {
                        userData(
                          User(id: id, email: email, status: userStatus, name: userName, gender: gender),
                        );
