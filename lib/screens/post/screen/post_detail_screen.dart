...
import 'package:base_mvvm/core/widget/empty_widget.dart';
import 'package:base_mvvm/core/widget/spinkit_indicator.dart';
...
import 'package:base_mvvm/screens/post/screen/create_post_screen.dart';
...
class PostDetailScreen extends StatefulWidget {
  const PostDetailScreen({Key? key, required this.post, this.user}) : super(key: key);
  ...
  snackBar(String message) {
    return ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Row(
          children: [const Icon(Icons.info, color: Color(0xFF2f87e8)), const SizedBox(width: 10), Text(message, style: const TextStyle(color: Colors.white))],
        ),
