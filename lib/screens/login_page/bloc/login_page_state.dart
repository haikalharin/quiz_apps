...
class LoginPageState with _$LoginPageState {
  ...
  const factory LoginPageState.loaded({String? userName,String? password,String? status,String? moveTo, String? error}) = _Loaded;

  const factory LoginPageState.failure(String? userName,String? password,String? status,String? moveTo, String? error) = _Failure;
